...
--relationships cycle
DROP TABLE IF EXISTS z_check_voc_1;
CREATE TABLE z_check_voc_1
AS
SELECT
    1 check_id,
...
DROP TABLE IF EXISTS z_check_voc_2;
CREATE TABLE z_check_voc_2
AS
SELECT 
    2 check_id,
...
DROP TABLE IF EXISTS z_check_voc_3;
CREATE TABLE z_check_voc_3
AS
SELECT 
    3 check_id,
...
DROP TABLE IF EXISTS z_check_voc_6;
CREATE TABLE z_check_voc_6
AS
SELECT 
    6 check_id,
...
DROP TABLE IF EXISTS z_check_voc_7;
CREATE TABLE z_check_voc_7
AS
SELECT 
    7 check_id,
...
WHERE (
        ...
        OR (
            c.valid_end_date::DATE = TO_DATE('20991231', 'YYYYMMDD')
        ...
        OR c.valid_start_date::DATE < TO_DATE('19000101', 'YYYYMMDD') -- some concepts have a real date < 1970
        )
;

--wrong valid_start_date, valid_end_date or invalid_reason for the voc_concept_relationship
DROP TABLE IF EXISTS z_check_voc_8;
CREATE TABLE z_check_voc_8
AS
SELECT 
    8 check_id,
...
FROM (
    SELECT r.*,
        CASE 
            WHEN (
                    r.valid_end_date::DATE = TO_DATE('20991231', 'YYYYMMDD')
                ...
                OR r.valid_start_date::DATE > CURRENT_DATE
                OR r.valid_start_date::DATE < TO_DATE('19000101', 'YYYYMMDD')
                THEN 1
            ELSE 0
            END check_flag
    FROM concept_relationship r
...
DROP TABLE IF EXISTS z_check_voc_9;
CREATE TABLE z_check_voc_9
AS
SELECT 
    9 check_id,
...
DROP TABLE IF EXISTS z_check_voc_10;
CREATE TABLE z_check_voc_10
AS
SELECT 
    10 check_id,
...
DROP TABLE IF EXISTS z_check_voc_11;
CREATE TABLE z_check_voc_11
AS
SELECT 
    11 check_id,
...
DROP TABLE IF EXISTS z_check_voc_12;
CREATE TABLE z_check_voc_12
AS
SELECT 
    12 check_id,
...
DROP TABLE IF EXISTS z_check_voc_13;
CREATE TABLE z_check_voc_13
AS
SELECT 
    13 check_id,
...
DROP TABLE IF EXISTS z_check_voc_14;
CREATE TABLE z_check_voc_14
AS
SELECT 
    14 check_id,
...
FROM
(
    SELECT relationship_id FROM concept_relationship
    EXCEPT DISTINCT
    SELECT relationship_id FROM relationship
) AS query_alias;

DROP TABLE IF EXISTS z_check_voc_15;
CREATE TABLE z_check_voc_15
AS
SELECT 
    15 check_id,
...
FROM
(
    SELECT concept_class_id FROM concept
    EXCEPT DISTINCT
    SELECT concept_class_id FROM concept_class
) AS query_alias;

DROP TABLE IF EXISTS z_check_voc_16;
CREATE TABLE z_check_voc_16
AS
SELECT 
    16 check_id,
...
FROM
(
    SELECT domain_id FROM concept
    EXCEPT DISTINCT
    SELECT domain_id FROM domain
) AS query_alias;

DROP TABLE IF EXISTS z_check_voc_17;
CREATE TABLE z_check_voc_17
AS
SELECT 
    17 check_id,
...
DROP TABLE IF EXISTS z_check_voc_errors_summary;
CREATE TABLE z_check_voc_errors_summary
AS
SELECT check_id, check_name, COUNT(*) AS row_count FROM z_check_voc_1
    GROUP BY check_id, check_name
UNION ALL
SELECT check_id, check_name, COUNT(*) AS row_count FROM z_check_voc_2
    GROUP BY check_id, check_name
UNION ALL
SELECT check_id, check_name, COUNT(*) AS row_count FROM z_check_voc_3
    GROUP BY check_id, check_name
UNION ALL
SELECT check_id, check_name, COUNT(*) AS row_count FROM z_check_voc_6
    GROUP BY check_id, check_name
UNION ALL
SELECT check_id, check_name, COUNT(*) AS row_count FROM z_check_voc_7
    GROUP BY check_id, check_name
UNION ALL
SELECT check_id, check_name, COUNT(*) AS row_count FROM z_check_voc_8
    GROUP BY check_id, check_name
UNION ALL
SELECT check_id, check_name, COUNT(*) AS row_count FROM z_check_voc_9
    GROUP BY check_id, check_name
UNION ALL
SELECT check_id, check_name, COUNT(*) AS row_count FROM z_check_voc_10
    GROUP BY check_id, check_name
UNION ALL
SELECT check_id, check_name, COUNT(*) AS row_count FROM z_check_voc_11
    GROUP BY check_id, check_name
UNION ALL
SELECT check_id, check_name, COUNT(*) AS row_count FROM z_check_voc_12
    GROUP BY check_id, check_name
UNION ALL
SELECT check_id, check_name, COUNT(*) AS row_count FROM z_check_voc_13
    GROUP BY check_id, check_name
UNION ALL
SELECT check_id, check_name, COUNT(*) AS row_count FROM z_check_voc_14
    GROUP BY check_id, check_name
UNION ALL
SELECT check_id, check_name, COUNT(*) AS row_count FROM z_check_voc_15
    GROUP BY check_id, check_name
UNION ALL
SELECT check_id, check_name, COUNT(*) AS row_count FROM z_check_voc_16
    GROUP BY check_id, check_name
UNION ALL
SELECT check_id, check_name, COUNT(*) AS row_count FROM z_check_voc_17
    GROUP BY check_id, check_name
;

SELECT * FROM z_check_voc_errors_summary
ORDER BY check_id;
