...
CREATE OR REPLACE TABLE vocabulary AS
SELECT
    *,
...
CREATE OR REPLACE TABLE drug_strength AS
SELECT
    drug_concept_id,
...
CREATE OR REPLACE TABLE concept_class AS
SELECT
    *,
...
CREATE OR REPLACE TABLE concept_synonym AS
SELECT
    *,
